...
public class User implements UserDetails, Serializable {
	...
	@Column(name = "ver_outra_solicitacao")
	...
	public void Atualizar(String userName, String fullName, Boolean enabled, Boolean verOutraSolicitacao, String email,
		...
		this.verOutraSolicitacao = verOutraSolicitacao;
		this.email = email;
	...
	public void setVerOutraSolicitacao(Boolean verOutraSolicitacao) {
		this.verOutraSolicitacao = verOutraSolicitacao;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((verOutraSolicitacao == null) ? 0 : verOutraSolicitacao.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (userName == null) {
			...
			return false;
		if (verOutraSolicitacao == null) {
			if (other.verOutraSolicitacao != null)
				return false;
		} else if (!verOutraSolicitacao.equals(other.verOutraSolicitacao))
			return false;
		return true;
	}
